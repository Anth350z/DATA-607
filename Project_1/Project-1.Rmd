...
data = read.csv(file = "https://raw.githubusercontent.com/Anth350z/DATA-607/master/Project_1/t_file.txt", header = FALSE, sep = "|",na.strings = c(" ", ""),stringsAsFactors = FALSE)[1:10] %>% na.omit()
